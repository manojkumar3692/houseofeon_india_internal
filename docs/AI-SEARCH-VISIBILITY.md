...
- Pricing correction: public, auto-applied EON20 qualifies for sale-price submission when landing page and checkout agree. Feed keeps regular price ₹1,249 and sale_price ₹999; schema uses ₹999. Both derive the effective price from checkout coupon math. The earlier removal of sale_price was too conservative. Feed retains existing product IDs for Meta.
...
## Under ₹1,000 follow-up

Added `/perfumes-under-1000`, linked from the footer and comparison hub and included in the sitemap. Prices explicitly disclose EON20. Product, home and category offer markup now uses the effective single-bottle price, and the comparison table shows regular and offer prices. Deploy this follow-up before refreshing Merchant Center. Sale eligibility guidance: https://support.google.com/merchants/answer/6324471 . Do not use the multi-bottle per-unit price as the single-bottle offer. If EON20 changes, rebuild static pages and audit the existing storefront price constants as well as checkout.
