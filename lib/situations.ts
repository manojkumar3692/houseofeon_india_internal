...
export const situations: Situation[] = [
  ...
  },
  {
    ...
    shortAnswer: "With EON20, Arctic Wave is ₹799 and the other 50ml House of Eon perfumes are ₹999. Start with Desert Tonka for warm richness, Silent Gold for quiet luxury or Arctic Wave for clean, polished freshness.",
    ...
    sections: [
      ...
      { heading: "How the price gets under ₹1000", body: ["House of Eon 50ml bottles have an original price of ₹1,249. Arctic Wave sells for ₹999 before coupons and ₹799 with EON20; other bottles are ₹999 with EON20. Check the price shown at checkout before ordering, since promotional pricing can change."] },
    ],
    faqs: [
      ...
      { question: "Are all House of Eon perfumes under ₹1000?", answer: "Their regular 50ml price is ₹1,249. With EON20, Arctic Wave is ₹799 and other bottles are ₹999; confirm the active price at checkout." },
    ],
