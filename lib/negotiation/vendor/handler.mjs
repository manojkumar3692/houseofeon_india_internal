import {validatePromotions} from './promotion-validation.mjs';
...
export function createConnectorHandler({workspaceId,installationId,secret,capabilities,listCatalog,getContext,createCheckout,reconcile,claimNonce,requirements=[],now=Date.now}) {
