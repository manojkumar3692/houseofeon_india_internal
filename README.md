...
The optional read-only negotiation connector and deployment steps are documented
in [production onboarding](docs/NEGOTIATION-READ-ONLY.md). Negotiated checkout is disabled.
